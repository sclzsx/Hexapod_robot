...
{ 	
  ...
  SPI_InitTypeDef  SPI_InitStructure;
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOD, ENABLE);	 //使能PB,D,G端口时钟 	

  GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable , ENABLE);//改变指定管脚映射 GPIO_Remap_SWJ_JTAGDisable ,JTAG-DP禁用 + SW-DP使能 
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3|GPIO_Pin_4;	//CSN/CE
 	GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化指定IO
	...
	GPIO_ResetBits(GPIOG,GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_2);
